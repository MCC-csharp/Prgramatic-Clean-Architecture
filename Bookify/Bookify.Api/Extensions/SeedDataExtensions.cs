...
public static class SeedDataExtensions
{
    public static void SeedData(this IApplicationBuilder app)
    {
        ...
        ISqlConnectionFactory sqlConnectionsFactory = scope.ServiceProvider.GetRequiredService<ISqlConnectionFactory>();
        using System.Data.IDbConnection connection = sqlConnectionsFactory.CreateConnection();
